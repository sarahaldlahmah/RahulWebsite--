...
//		driver.findElement(By.cssSelector("input[placeholder ='Phone Number']")).clear();
		...
		// driver.findElement(By.cssSelector("button[class =
		// 'reset-pwd-btn']")).click();
...
//toList.findElement(By.xpath("//option[@value='MAA']")).click();
		...
		WebElement FromList = driver
				.findElement(By.xpath("//div/div/input[@id='ctl00_mainContent_ddl_destinationStation1_CTXT']"));
